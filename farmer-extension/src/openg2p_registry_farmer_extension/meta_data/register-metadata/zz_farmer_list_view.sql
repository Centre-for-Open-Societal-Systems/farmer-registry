...
SET search_result_schema = '[
  ...
  {"field_name":"is_duplicated","display_label":"Duplicate","order":7}
]'::json,
filter_schema = '[
  ...
  {"field_name":"is_duplicated","display_label":"Duplicate Status","filter_type":"dropdown","order":6,"allowed_operators":["eq","in"],"options_source":[{"value":"true","label":"DUPLICATE"},{"value":"false","label":"UNIQUE"}]}
]'::json
